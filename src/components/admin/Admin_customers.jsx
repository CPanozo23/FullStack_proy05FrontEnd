...
const Admin_customer = () => {
    ...
    const userList = user?.users?.map(userData => {
        ...
        return (
            ...
            <article key={userData._id} className="border-bottom">
                ...
                <div className="row px-1">
                    ...
                    <div className="col-2">
                    <button type="button" class="btn btn-primary my-1">Ver sesiones</button>
                    <button type="button" class="btn btn-primary my-1">Ver compras</button>
